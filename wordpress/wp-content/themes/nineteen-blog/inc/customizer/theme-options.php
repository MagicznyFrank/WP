...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'nineteen-blog' ),
	'priority'   => 100,
...
$wp_customize->add_section('section_sidebar', array(    
	'title'       => __('Sidebar Options', 'nineteen-blog'),
...
$wp_customize->add_setting('blog_sidebar', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'nineteen_blog_sanitize_select',
	'transport'         => 'refresh',
	)
);
...
$wp_customize->add_control('blog_sidebar', 
	array(		
	'label' 	=> __('Blog Sidebar', 'nineteen-blog'),
	'section' 	=> 'section_sidebar',
	'settings'  => 'blog_sidebar',
	'type' 		=> 'radio',
	'choices' 	=> array(		
		'left-sidebar' 	=> __( 'Left Sidebar', 'nineteen-blog'),						
		'right-sidebar' => __( 'Right Sidebar', 'nineteen-blog'),	
		'no-sidebar' 	=> __( 'No Sidebar', 'nineteen-blog'),	
		),	
	)
);
...
$wp_customize->add_control('single_post_sidebar', 
	array(		
	'label' 	=> __('Single Post Sidebar', 'nineteen-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('archive_sidebar', 
	array(		
	'label' 	=> __('Archive Sidebar', 'nineteen-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('page_sidebar', 
	array(		
	'label' 	=> __('Page Sidebar', 'nineteen-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'nineteen-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'excerpt_length', array(
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'nineteen_blog_sanitize_number_range',
	'transport'         => 'refresh',
) );

$wp_customize->add_control( 'excerpt_length', array(
	'label'       => __( 'Excerpt Length', 'nineteen-blog' ),
	'description' => __( 'Note: Min 5 & Max 100.', 'nineteen-blog' ),
